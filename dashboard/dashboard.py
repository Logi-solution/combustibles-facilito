...
st.markdown(
    ...
    @media (max-width: 768px) {
        ...
        .st-key-filters_row > div > [data-testid="stHorizontalBlock"], .st-key-kpi_row > div > [data-testid="stHorizontalBlock"],
        .st-key-row1 > div > [data-testid="stHorizontalBlock"], .st-key-row2 > div > [data-testid="stHorizontalBlock"] {
            flex-direction: column !important;
        }
        .st-key-filters_row > div > [data-testid="stHorizontalBlock"] > [data-testid="stColumn"],
        .st-key-kpi_row > div > [data-testid="stHorizontalBlock"] > [data-testid="stColumn"],
        .st-key-row1 > div > [data-testid="stHorizontalBlock"] > [data-testid="stColumn"],
        .st-key-row2 > div > [data-testid="stHorizontalBlock"] > [data-testid="stColumn"] {
            width: 100% !important;
